...
function updateSubtotal() {
    ...
    discount = ["ostad10", "ostad5"];

    let applyButton = document.querySelector(
        ".cart-container .subtotal .discount .button"
    );
    ...
    applyButton.addEventListener("click", () => {
        ...
        if (promoCode == discount[0]) {
            ...
            notValidCoupon.classList.add("active");
            setTimeout(() => {
                notValidCoupon.classList.remove("active");
            }, 2000);
        }
        document.querySelector(".subtotal .dis-ammount span").innerText =
...
let notValidCoupon = document.querySelector(".coupon-not-valid-msg");
